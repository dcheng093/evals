...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/07/14 15:20:36 by asyeo             #+#    #+#             */
/*   Updated: 2026/07/14 15:20:44 by asyeo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	validate_input(int *input, char **nums, int num, size_t idx)
{
	long long	tmp;
	size_t		i;

	tmp = ft_atoi_pushswap(nums[num]);
...
void	parse_input(char **av, int *input)
{
	...
	while (av[i])
	{
		...
		j = 0;
		while (nums[j])
			validate_input(input, nums, j++, idx++);
		free_split(nums);
		i++;
	}
}
