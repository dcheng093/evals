...
/*   Updated: 2026/01/29 16:01:49 by yosherau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const ClapTrap &original):
	name(original.name), hitPoints(original.hitPoints), energyPoints(original.energyPoints), attackDamage(original.attackDamage)
{
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	if (this->hitPoints == 0)
	{
		std::cout << "ClapTrap " << this->name << " is already cooked :/" << std::endl;
		return ;
	}
...
bool	ClapTrap::canAct(void) const
{
	...
	{
		std::cout << "ClapTrap " << this->name << " does not have enough energy points to perform an action :/" << std::endl;
		return (false);
	}
	return (true);
}
...
ClapTrap::~ClapTrap(void)
{
	std::cout << "ClapTrap " << this->name << "'s destructor has been called" << std::endl;
}